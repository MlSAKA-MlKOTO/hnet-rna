...
def generate(model, prompt: str, max_tokens: int = 1024, temperature: float = 1.0, top_p: float = 0.9,tokenizer = ByteTokenizer()):
...
def yield_utf8_chunks(g,tokenizer=ByteTokenizer()):
